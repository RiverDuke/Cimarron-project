...
import backGrnd from "../images/stock-photo-art-concrete-texture-for-background-in-black-grey-and-white-colors-298514801-1.jpg";

// function MenuIcon() {
//   return (
//     // <div className="menu-icon" id="menu">
//     <div className="navbar hello" id="menu">
